  ...
  <div class="panel-header bg:#FF9E27">
    <div class="page-inner py-4">
      <div class="page-header text-black">
        <!-- judul halaman -->
        <h4 class="page-title text-black"><i class="fas fa-file-signature mr-2"></i> Laporan Stok</h4>
        <!-- breadcrumbs -->
            ...
            <div class="table-responsive">
              ...
              <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
                ...
                <tbody>
                  ...
                  $no = 1;
                  $query = mysqli_query($mysqli, "SELECT a.id_barang, a.nama_barang, a.stok_minimum, a.stok
