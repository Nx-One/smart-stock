    ...
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
            <div class="page-header text-white">
                <!-- judul halaman -->
                <h4 class="page-title text-black"><i class="fas fa-home mr-2"></i> Dashboard</h4>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
              ...
              $query = mysqli_query($mysqli, "SELECT a.id_barang, a.nama_barang, a.stok_minimum, a.stok, a.price
              ...
              while ($data = mysqli_fetch_assoc($query)) { ?>
                        ...
                        <tr>
                            ...
                            <td width="70" class="text-right"><span class="badge badge-danger"><?php echo number_format($data['stok'], 0, '', '.'); ?></span></td>
