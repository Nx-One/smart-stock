...
// jika file di include oleh file lain, tampilkan isi file
  ...
  // jika module yang dipilih "form_ubah_barang" dan hak akses bukan "Owner"
  ...
  elseif ($_GET['module'] == 'user' && $_SESSION['hak_akses'] == 'Kepala Gudang') {
  ...
  elseif ($_GET['module'] == 'form_entri_user' && $_SESSION['hak_akses'] == 'Kepala Gudang') {
  ...
  elseif ($_GET['module'] == 'form_ubah_user' && $_SESSION['hak_akses'] == 'Kepala Gudang') {
  ...
  // jika module yang dipilih "cashier" dan hak akses "Administrator"
  elseif ($_GET['module'] == 'cashier' && $_SESSION['hak_akses'] == 'Admin Gudang') {
    // panggil file tampil data cashier
    include "modules/cashier/index.php";
  }
  // jika module yang dipilih "cashier&cetak"
  elseif ($_GET['module'] == 'cetak') {
    // panggil file tampil data cashier
    include "modules/cashier/cetak.php";
  }

  // jika module yang dipilih tidak ada
  else {
    // panggil file halaman error 404
    include "404.html";
  }
}
